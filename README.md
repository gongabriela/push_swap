...
[1. Data Structures - Linked Lists](#data-structures---linked-lists)
  ...
  [1.1. What is a Linked List?](#what-is-a-linked-list)
       
   [1.1.1. Advantages of Linked Lists](#advantages-of-linked-lists)
       
   [1.1.2. Disadvantages of Linked Lists](#disadvantages-of-linked-lists)
      
   [1.1.3. Linked Lists operations](#linked-list-operations)
       
   [1.1.4. Creating a Linked List: About Structs](#creating-a-linked-list-about-structs)

[2. Algorithms in a Nutshell](#algorithms-in-a-nutshell)
   
  [2.1. What makes something an algorithm?](#what-makes-something-an-algorithm)
   
  [2.2. Types of Algorithms](#types-of-algorithms)
   
  [2.3. Complexity Analysis: Big O Notation](#complexity-analysis-big-o-notation)

[3. Understanding the Turk Algorithm](#understanding-the-turk-algorithm)
   
  [3.1. Phase 1: Pushing to Stack B](#phase-1-pushing-to-stack-b)
       
   [3.1.1. Find its "best friend" in B](#1-find-its-best-friend-in-b)
       
   [3.1.2. Calculate the cost](#2-calculate-the-cost)
      
   [3.1.3. Sort the last three in A](#3-sort-the-last-three-in-a)
  
  [3.2. Phase 2: Pushing Back to A](#phase-2-pushing-back-to-a)
  
  [3.3. Final Step: Rotate A one last time](#final-step-rotate-a-one-last-time)

[4. Explaining my projects code](#explaining-my-projects-code)
   
   [4.1. Part I - Parsing the arguments and initializing the stacks](#part-i---parsing-the-arguments-and-initializing-the-stacks)
   
   [4.2. Part II - Writing the functions for the movements](#part-ii---writing-the-functions-for-the-movements)
   
   [4.3. Part III - Writing the algorithm](#part-iii---writing-the-algorithm)
